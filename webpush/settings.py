"""
Django settings for webpush project.
...
SECRET_KEY = 'django-insecure-@v-e^o1p6l6*f93*!h3yi)=le@r4@!_thu-fva^^^!h-jv2n8h'
...
WSGI_APPLICATION = 'webpush.wsgi.application'
...
SECURE_COOKIE_SECURE = False  # Set to True in production with HTTPS
